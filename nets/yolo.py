...
class YoloBody(nn.Module):
    ...
    # 添加attention参数来加入注意力机制，attention = 0：表示原版，attention=1表示senet，attention=2表示cbam，attention=3表示ecanet
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False, attention=2):
        ...
        if attention >= 1 and attention <= 3:
            self.feat1_attention = attention_blocks[attention - 1](512)  # 括号里表示通道数
